...
window.title("Coding Challenge | Python Calculator")
#function
def about():
...
ac = Button(mainFrame, text="AC", fg="black", image=acimage, bd=0, bg="black", cursor="hand2",
               command=lambda: clearAll()).grid(row=2, column=3, padx=1, pady=1)
...
clear = Button(mainFrame, text="AC", fg="black", image=clearimage, bd=0, bg="black", cursor="hand2",
               command=lambda: clearButton()).grid(row=1, column=3, padx=1, pady=1)
...
percentage = Button(mainFrame, fg="black", image=expan_btnimage, bd=0, bg="black", cursor="hand2",
               command=lambda: expand()).grid(row=3, column=3, padx=1, pady=1)
...
divide = Button(mainFrame, text="/", fg="white",image=divideimage, bd=0, bg="black", cursor="hand2",
                command=lambda: clickButton("/")).grid(row=0, column=0, padx=1, pady=1)
...
nine = PhotoImage(file = r"images/nine.png")
...
multiply = Button(mainFrame, text="*", fg="white",image=multiimage, bd=0, bg="black", cursor="hand2",
                  command=lambda: clickButton("*")).grid(row=0, column=1, padx=1, pady=1)
...
two = PhotoImage(file = r"images/two.png")
...
three = PhotoImage(file = r"images/three.png")
...
tan_btn = PhotoImage(file = r"images/tan_btn.png")
...
tan_btn = Button(mainFrame, text="tan", fg="black",image=tan_btnimage, bd=0, bg="black", cursor="hand2",
               command=lambda: clickButton("tan(")).grid(row=6, column=2, padx=0, pady=0)
...
button_sq=PhotoImage(file=r"images/square2.png")
sq_btnimage = button_sq.subsample(4,4)         
button_sq = Button(mainFrame, text="square", fg="black", image=sq_btnimage,bd=0, bg="black", cursor="hand2",
                command=lambda: clickButton("**2")).grid(row=7, column=0, padx=1 ,pady=1)


button_sqrt=PhotoImage(file=r"images/sqrt.png")
sqrt_btnimage = button_sqrt.subsample(4,4)         
button_sqrt = Button(mainFrame, text="square", fg="black", image=sqrt_btnimage,bd=0, bg="black", cursor="hand2",
                command=lambda: clickButton("sqrt(")).grid(row=7, column=1, padx=1 ,pady=1)
...
image_path = os.path.join("images", "icon.png")
# guiForm()
icon = PhotoImage(file=image_path)
window.iconphoto(False, icon)
# window.iconbitmap(r"images/rev.ico")
